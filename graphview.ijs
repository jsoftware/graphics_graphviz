...
FILTER=: 'Graph File (*.dot)|*.dot|All Files (*.*)|*.*'
PATHSEP=: '/'
...
graphviz_open_button=: 3 : 0
  fname=. }:wd'mb open "Open Graph File" "" "" "',FILTER,'" ofn_filemustexist'
  if. *#fname do. load fname end.
)
...
graphviz_neatoguide_button=: navigate bind ('file:///',ADDONDIR,'\doc\neatoguide.html')
